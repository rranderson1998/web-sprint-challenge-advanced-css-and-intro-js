 ...
 * getArtistByIndex returns a string in the format `The artist at index {id}(index) is {name}.`
 * 
...
function addArtist(info){
  ...
  const artistRicardo = {id: 22,
    name: "Ricardo Anderson",
    years: "1998 - current day",
    genre: "Hip-Hop",
    nationality: "African-American",
    bio: "Favorite color is red. Favorite food is pizza."
}

console.log(addArtist(artistRicardo))
